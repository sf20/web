...
public class WebServiceLocator extends org.apache.axis.client.Service implements openDemo.service.sync.jianlin.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://202.109.254.219:8088/HR/DataInterface/Webservice.asmx";
    ...
    public openDemo.service.sync.jianlin.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            openDemo.service.sync.jianlin.WebServiceSoapStub _stub = new openDemo.service.sync.jianlin.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (openDemo.service.sync.jianlin.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                openDemo.service.sync.jianlin.WebServiceSoapStub _stub = new openDemo.service.sync.jianlin.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sharegoo.cn/", "WebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sharegoo.cn/", "WebServiceSoap"));
        }
