...
public class LoginResult  extends openDemo.service.sync.jomoows.LbeResult  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.livebos.apex.com/", "loginResult"));
