...
public class LogoutResponse  implements java.io.Serializable {
    private openDemo.service.sync.jomoows.LogoutResult logoutResult;

    public LogoutResponse() {
    }

    public LogoutResponse(
           openDemo.service.sync.jomoows.LogoutResult logoutResult) {
           this.logoutResult = logoutResult;
    }


    /**
     * Gets the logoutResult value for this LogoutResponse.
     * 
     * @return logoutResult
     */
    public openDemo.service.sync.jomoows.LogoutResult getLogoutResult() {
        return logoutResult;
    }


    /**
     * Sets the logoutResult value for this LogoutResponse.
     * 
     * @param logoutResult
     */
    public void setLogoutResult(openDemo.service.sync.jomoows.LogoutResult logoutResult) {
        this.logoutResult = logoutResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.livebos.apex.com/", "logoutResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("logoutResult");
        elemField.setXmlName(new javax.xml.namespace.QName("", "LogoutResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.livebos.apex.com/", "logoutResult"));
